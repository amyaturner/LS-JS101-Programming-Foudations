...
// ANSWER: { first: [1, 2] }
// BOOM! Correct (just barely got this one!)
...
We can declare and initialize numArray
with a reference to a copy of the original array:
*/
...
// Basically, we can use .slice() or .concat() to create a copy of the array
// in order to not reference the same array.
